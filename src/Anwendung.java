...
public class Anwendung {
    ...
    public static void main(String[] args) {
        ...
        //User eingabe abfragen starten... namen eingeben usw

        String eingabeBenutzer;
        eingabeBenutzer = "Peter";


        //Spielercharakter erstellen
        Character Spieler = new Character(eingabeBenutzer, 100, 2,"Gude sagen");
        ...
        System.out.print(" mit "); System.out.print(Item4.getDamage()); System.out.print("Schaden!!1111!!1OMG");
